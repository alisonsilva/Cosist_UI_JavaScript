Ext.define('Plantao.view.administracao.Administracao', {
    ...
    items: [{
				...
				itemdblclick : function(me, record, item, index, e, eOpts){
					...
					if(flRecusado) {
						var win2 = Ext.create('Ext.window.Window', {
							...
							layout: 'fit',
							items: [Ext.create('Plantao.view.gerenciarrecusa.GerenciarRecusa')]      
						});
						win2.show();
						var vwFiltro = Ext.ComponentQuery.query('#gridGerenciarRecusa')[0];
						vwFiltro.fireEvent('rerender', record);											
					} else if(flPermutado) {
						var win2 = Ext.create('Ext.window.Window', {
							height: 650,
							width: 1100,
							x: 200,
							y: 100,
							title: 'Gerenciar permuta',
							closable: true,
							plain: true,
							modal: true,
							id: 'windowAdministracaoPermuta',
							layout: 'fit',
							items: [Ext.create('Plantao.view.gerenciarpermuta.GerenciarPermuta')]      
						});
						win2.show();
						var vwFiltro = Ext.ComponentQuery.query('#gridGerenciarPermuta')[0];
						vwFiltro.fireEvent('rerender', index);											
					}
                },				
        ...
        dockedItems: [{
            ...
            items: ['->',{
                text: '',
                itemId: 'btnDownloadEscalasFiltradas',
                iconCls: 'icon-download',
                tooltip: 'Baixar relatório de plantões',
                disabled: false,
                handler : 'onDownloadEscalasFiltradasClick'
            },{
                text: '',
                itemId: 'btnNovaEscala',
                iconCls: 'icon-plus',
                tooltip: 'Adicionar novo plantão',
                disabled: false,
                handler : 'onNovaEscalaClick'
            }]
        }],
