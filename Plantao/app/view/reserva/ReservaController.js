Ext.define('Plantao.view.reserva.ReservaController', {
            ...
            items: [{
                ...
                listeners: {
                    selectionchange: function (view, selections, options) {
                        ...
                        Plantao.util.JsonPUtil.executaChamadaPostObjeto('https://tjdf199.tjdft.jus.br/cosist/servicos/Plantaojustica/dadosbasicos/novoInteresse'
                                    , obj, null, {executaChamadaSuccess : function(result, obj){
                                        var info = result.infoRetornoPlantaoJustica;
                                        var codigo = info.codigo;
                                        if(codigo == 0) {
                                            Plantao.util.DeviceUtil.showAlertaConfirma('Info', 'Reserva cadastrada com sucesso', Ext.Msg.MESSAGE, function(){
                                                Plantao.util.JsonPUtil.executaChamada(
                                            ...
                                            Plantao.util.DeviceUtil.showAlertaConfirma('Erro', 'Erro ao cadastrar reserva: ' + info.mensagem, Ext.Msg.ERROR, function(){});
                                        }
                                    }, executaChamadaError: function(obj){
                                    }});
                    }
    ...
    onRemoveReservaClick : function() {
        ...
        if (userGrid.getSelectionModel().hasSelection()) {
           ...
           var interesse = {matriculaOficial: matricula, setorKey: setorKey, concursoId:localStorage.getItem("concursoId")};
            Plantao.util.DeviceUtil.showAlertaConfirmaCancela('Alerta', 'Tem certeza que deseja apagar a reserva?', Ext.Msg.QUESTION, function(){
                Plantao.util.JsonPUtil.executaChamadaPostObjeto('https://tjdf199.tjdft.jus.br/cosist/servicos/oficiaisjustica/dadosbasicos/removeInteresse'
                            , interesse, null, {executaChamadaSuccess : function(result, obj){
                                ...
                                if(codigo == 0) {
                                    ...
                                    me.onRefreshListSetores();
                                    Plantao.util.DeviceUtil.showAlertaConfirma('Info', 'Reserva removida com sucesso', Ext.Msg.INFO, function(){});
                                } else {
                                    Plantao.util.DeviceUtil.showAlertaConfirma('Erro', 'Erro ao executar chamada: ' + mensagem, Ext.Msg.ERROR, function(){});
                                }
    ...
    moveSelectedRow : function (grid, direction) {
        ...
        grid.getEl().mask();
        Plantao.util.JsonPUtil.executaChamadaPostObjeto('https://tjdf199.tjdft.jus.br/cosist/servicos/oficiaisjustica/dadosbasicos/priorizarInteresses'
