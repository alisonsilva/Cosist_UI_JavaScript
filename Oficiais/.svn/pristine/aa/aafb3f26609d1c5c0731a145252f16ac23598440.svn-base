Ext.define('Oficiais.util.DeviceUtil', {
    singleton: true,
    scope: this,
    fileName: '',
    ...
    setCabecalho : function() {
        ...
        var html = "<div style=\'width: 95%; margin: auto; padding: 0; display: table; border: 0px;  font-size: 13px; text-align: left; color: #666666; padding-left: 5px; padding-bottom: 5px; line-height: 92%;\'> "
            ...
            +"        <div style=\'padding-left: 0.5em; padding-right: 0.5em; padding-top: 0.7em;  display: table-cell;  font-size: 14px; color: #330066;\'>Procedimento de movimentação: <b>"+ processo +"</b></div>"
            +"    </div> "
            +"</div>";
        bar.setHtml(html);  
    },
