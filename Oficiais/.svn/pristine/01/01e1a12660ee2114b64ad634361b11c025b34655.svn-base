Ext.define('Oficiais.view.ranking.Ranking', {
    ...
    requires: [
        ...
        'Oficiais.view.ranking.RankingController',
    ...
    title: 'Classificação',
    tooltip: 'Visualize a classificação dos oficiais para o procedimento atual',
    id: 'viewRanking',
    height: 650,
    layout: {
        type: 'border'
